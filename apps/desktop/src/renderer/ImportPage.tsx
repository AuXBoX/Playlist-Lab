          ...
          >
            ...
            <div className="button-group">
              ...
              <button 
                ...
                disabled={importingPlaylist === playlist.url || fetchingUrl === playlist.url}
              >
                {(importingPlaylist === playlist.url || fetchingUrl === playlist.url) ? '...' : 'Import'}
              </button>
              <button 
    ...
    <div className="import-tab-content">
      ...
      <div className="url-import-section">
        ...
        <div className="search-bar-row">
          ...
          <button 
            className="btn btn-primary"
            onClick={() => importDirectFromUrl('youtube', ytMusicUrl, 'YouTube Music Playlist')}
            disabled={!ytMusicUrl.trim() || importingPlaylist === ytMusicUrl || fetchingUrl === ytMusicUrl}
          >
            {(importingPlaylist === ytMusicUrl || fetchingUrl === ytMusicUrl) ? '...' : 'Import'}
          </button>
        </div>
      </div>
      ...
      <div className="playlist-grid">
        {youtubePopular.map((playlist, i) => (
          <div 
            key={i} 
            className="import-playlist-card clickable"
            onClick={() => importDirectFromUrl('youtube', playlist.url, playlist.name)}
          >
            <div className="playlist-info">
              <span className="playlist-name">{playlist.name}</span>
    ...
    <div className="import-tab-content">
      <div className="url-import-section">
        ...
        <div className="search-bar-row">
          ...
          <button 
            className="btn btn-primary"
            onClick={() => importDirectFromUrl('amazon', amazonMusicUrl, 'Amazon Music Playlist')}
            disabled={!amazonMusicUrl.trim() || importingPlaylist === amazonMusicUrl || fetchingUrl === amazonMusicUrl}
          >
            {(importingPlaylist === amazonMusicUrl || fetchingUrl === amazonMusicUrl) ? '...' : 'Import'}
          </button>
        </div>
      </div>
      ...
      <div className="playlist-grid">
        {amazonPopular.map((playlist, i) => (
          <div 
            key={i} 
            className="import-playlist-card clickable"
            onClick={() => importDirectFromUrl('amazon', playlist.url, playlist.name)}
          >
            <div className="playlist-info">
              <span className="playlist-name">{playlist.name}</span>
            ...
            <div className="button-group">
              <button 
                className="btn btn-small btn-primary"
                onClick={(e) => { e.stopPropagation(); importDirectFromUrl('amazon', playlist.url, playlist.name); }}
                disabled={importingPlaylist === playlist.url || fetchingUrl === playlist.url}
              >
                {(importingPlaylist === playlist.url || fetchingUrl === playlist.url) ? '...' : 'Import'}
              </button>
      ...
      <div style={{ marginTop: '24px', padding: '16px', background: '#1a1a1a', borderRadius: '8px' }}>
        <p style={{ color: '#888', fontSize: '13px' }}>
          ?? Amazon Music does not provide a public API. Import works by scraping public playlist pages, 
    ...
    <div className="import-tab-content">
      <div className="url-import-section">
        ...
        <div className="search-bar-row">
          ...
          <button 
            className="btn btn-primary"
            onClick={() => importDirectFromUrl('qobuz', qobuzUrl, 'Qobuz Playlist')}
            disabled={!qobuzUrl.trim() || importingPlaylist === qobuzUrl || fetchingUrl === qobuzUrl}
          >
            {(importingPlaylist === qobuzUrl || fetchingUrl === qobuzUrl) ? '...' : 'Import'}
          </button>
        </div>
      </div>
      ...
      <div className="playlist-grid">
        {qobuzPopular.map((playlist, i) => (
          <div 
            key={i} 
            className="import-playlist-card clickable"
            onClick={() => importDirectFromUrl('qobuz', playlist.url, playlist.name)}
          >
            <div className="playlist-info">
              <span className="playlist-name">{playlist.name}</span>
            ...
            <div className="button-group">
              <button 
                className="btn btn-small btn-primary"
                onClick={(e) => { e.stopPropagation(); importDirectFromUrl('qobuz', playlist.url, playlist.name); }}
                disabled={importingPlaylist === playlist.url || fetchingUrl === playlist.url}
              >
                {(importingPlaylist === playlist.url || fetchingUrl === playlist.url) ? '...' : 'Import'}
              </button>
      ...
      <div style={{ marginTop: '24px', padding: '16px', background: '#1a1a1a', borderRadius: '8px' }}>
        <p style={{ color: '#888', fontSize: '13px' }}>
          ?? Qobuz has limited API access. Import works by scraping public playlist pages.
        </p>
      </div>
    </div>
  );
